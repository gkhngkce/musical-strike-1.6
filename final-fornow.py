...
DEVICE_INDEX=1 #input device index
...
def calculateSpeedModifier(midi):
    #Do not increase more than 3 for prevent skipping
    return min(3,(SPEED+(NOTE_COUNTS[midi]/SPEED_MODIFIER)+(NOTE_COUNTS[midi]/SPEED_MODIFIER)))
